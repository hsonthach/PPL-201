...
class BKITParser ( Parser ):
    ...
    class Global_vardeclContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitGlobal_vardecl" ):
                return visitor.visitGlobal_vardecl(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Vardecl_listContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitVardecl_list" ):
                return visitor.visitVardecl_list(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Para_decllistContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitPara_decllist" ):
                return visitor.visitPara_decllist(self)
            else:
                return visitor.visitChildren(self)
