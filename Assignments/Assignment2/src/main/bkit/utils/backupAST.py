...
class If(Stmt):
    ...
    def __str__(self):
        # ifstmt = "If((" + str(self.ifthenStmt[0][0]) + \
        #     "," + printlist(self.ifthenStmt[0][1]) + \
        #     "," + printlist(self.ifthenStmt[0][2]) + ")"
        # if (len(self.elseStmt)):
        #     else_stmt = "(" + printlist(self.elseStmt[0]) + \
        #         "," + printlist(self.elseStmt[1]) + "))"
